import * as t from './fitConstantsTypes'
import { ValueType } from './fitTypes'

export default class FitConstants {

	//NOTE: not sure what this is...
	static bool = true

	static activity: t.activityT = {
		__name: "activity",
		"manual": 0,
		"auto_multi_sport": 1,
	};

	static activity_class: t.activity_classT = {
	...
	static activity_level: t.activity_levelT = {
	...
	static activity_subtype: t.activity_subtypeT = {
	...
	static activity_type: t.activity_typeT = {
	...
	static analog_watchface_layout: t.analog_watchface_layoutT = {
	...
	static ant_network: t.ant_networkT = {
		__name: "ant_network",
		"public": 0,
		"antplus": 1,
		"antfs": 2,
	...
	static antplus_device_type: t.antplus_device_typeT = {
	...
	static attitude_stage: t.attitude_stageT = {
	...
	static attitude_validity: t.attitude_validityT = {
	...
	static auto_activity_detect: t.auto_activity_detectT = {
	...
	static auto_sync_frequency: t.auto_sync_frequencyT = {
	...
	static autolap_trigger: t.autolap_triggerT = {
	...
	static autoscroll: t.autoscrollT = {
		__name: "autoscroll",
		"none": 0,
		"slow": 1,
		"medium": 2,
	...
	static backlight_mode: t.backlight_modeT = {
	...
	static backlight_timeout: t.backlight_timeoutT = {
		__name: "backlight_timeout",
		"infinite": 0,
	};

	static battery_status: t.battery_statusT = {
	...
	static bench_press_exercise_name: t.bench_press_exercise_nameT = {
	...
	static bike_light_beam_angle_mode: t.bike_light_beam_angle_modeT = {
		__name: "bike_light_beam_angle_mode",
		"manual": 0,
		"auto": 1,
	};

	static bike_light_network_config_type: t.bike_light_network_config_typeT = {
	...
	static body_location: t.body_locationT = {
	...
	static calf_raise_exercise_name: t.calf_raise_exercise_nameT = {
	...
	static camera_event_type: t.camera_event_typeT = {
	...
	static camera_orientation_type: t.camera_orientation_typeT = {
	...
	static cardio_exercise_name: t.cardio_exercise_nameT = {
	...
	static carry_exercise_name: t.carry_exercise_nameT = {
	...
	static checksum: t.checksumT = {
		__name: "checksum",
		"clear": 0,
		"ok": 1,
	};

	static chop_exercise_name: t.chop_exercise_nameT = {
	...
	static climb_pro_event: t.climb_pro_eventT = {
	...
	static comm_timeout_type: t.comm_timeout_typeT = {
	...
	static connectivity_capabilities: t.connectivity_capabilitiesT = {
	...
	static core_exercise_name: t.core_exercise_nameT = {
	...
	static course_capabilities: t.course_capabilitiesT = {
	...
	static course_point: t.course_pointT = {
		__name: "course_point",
		"generic": 0,
		"summit": 1,
		"valley": 2,
	...
	static crunch_exercise_name: t.crunch_exercise_nameT = {
	...
	static curl_exercise_name: t.curl_exercise_nameT = {
	...
	static date_mode: t.date_modeT = {
		__name: "date_mode",
		"day_month": 0,
		"month_day": 1,
	};

	static date_time: t.date_timeT = {
		__name: "date_time",
		"min": 0,
	};

	static day_of_week: t.day_of_weekT = {
		__name: "day_of_week",
		"sunday": 0,
		"monday": 1,
		"tuesday": 2,
	...
	static deadlift_exercise_name: t.deadlift_exercise_nameT = {
	...
	static device_index: t.device_indexT = {
		__name: "device_index",
		"creator": 0,
	};

	static digital_watchface_layout: t.digital_watchface_layoutT = {
	...
	static display_heart: t.display_heartT = {
	...
	static display_measure: t.display_measureT = {
	...
	static display_orientation: t.display_orientationT = {
	...
	static display_position: t.display_positionT = {
	...
	static display_power: t.display_powerT = {
		__name: "display_power",
		"watts": 0,
		"percent_ftp": 1,
	};

	static dive_alarm_type: t.dive_alarm_typeT = {
		__name: "dive_alarm_type",
		"depth": 0,
		"time": 1,
	};

	static dive_backlight_mode: t.dive_backlight_modeT = {
		__name: "dive_backlight_mode",
		"at_depth": 0,
		"always_on": 1,
	};

	static dive_gas_status: t.dive_gas_statusT = {
	...
	static event_type: t.event_typeT = {
		__name: "event_type",
		"start": 0,
		"stop": 1,
	...
	static exd_data_units: t.exd_data_unitsT = {
	...
	static exd_descriptors: t.exd_descriptorsT = {
	...
	static exd_display_type: t.exd_display_typeT = {
	...
	static exd_layout: t.exd_layoutT = {
		__name: "exd_layout",
		"full_screen": 0,
		"half_vertical": 1,
		"half_horizontal": 2,
	...
	static exd_qualifiers: t.exd_qualifiersT = {
	...
	static exercise_category: t.exercise_categoryT = {
	...
	static favero_product: t.favero_productT = {
		__name: "favero_product",
		"assioma_uno": 10,
		"assioma_duo": 12,
	};

	static file_flags: t.file_flagsT = {
		__name: "file_flags",
		"read": 0,
		"write": 0,
		"erase": 0,
	...
	static fit_base_type: t.fit_base_typeT = {
	...
	static fit_base_unit: t.fit_base_unitT = {
	...
	static fitness_equipment_state: t.fitness_equipment_stateT = {
	...
	static flye_exercise_name: t.flye_exercise_nameT = {
	...
	static garmin_product: t.garmin_productT = {
	...
	static goal_recurrence: t.goal_recurrenceT = {
	...
	static goal_source: t.goal_sourceT = {
		__name: "goal_source",
		"auto": 0,
		"community": 1,
		"user": 2,
	...
	static hip_raise_exercise_name: t.hip_raise_exercise_nameT = {
	...
	static hip_stability_exercise_name: t.hip_stability_exercise_nameT = {
	...
	static hip_swing_exercise_name: t.hip_swing_exercise_nameT = {
	...
	static hr_type: t.hr_typeT = {
		__name: "hr_type",
		"normal": 0,
		"irregular": 1,
	};

	static hr_zone_calc: t.hr_zone_calcT = {
		__name: "hr_zone_calc",
		"custom": 0,
		"percent_max_hr": 1,
		"percent_hrr": 2,
	...
	static hyperextension_exercise_name: t.hyperextension_exercise_nameT = {
	...
	static language_bits_0: t.language_bits_0T = {
	...
	static language_bits_1: t.language_bits_1T = {
	...
	static language_bits_2: t.language_bits_2T = {
	...
	static language_bits_3: t.language_bits_3T = {
	...
	static language_bits_4: t.language_bits_4T = {
	...
	static lap_trigger: t.lap_triggerT = {
		__name: "lap_trigger",
		"manual": 0,
		"time": 1,
		"distance": 2,
	...
	static lateral_raise_exercise_name: t.lateral_raise_exercise_nameT = {
	...
	static left_right_balance: t.left_right_balanceT = {
		__name: "left_right_balance",
		"mask": 0,
		"right": 0,
	};

	static left_right_balance_100: t.left_right_balance_100T = {
		__name: "left_right_balance_100",
		"mask": 0,
		"right": 0,
	};

	static leg_curl_exercise_name: t.leg_curl_exercise_nameT = {
	...
	static leg_raise_exercise_name: t.leg_raise_exercise_nameT = {
	...
	static length_type: t.length_typeT = {
		__name: "length_type",
		"idle": 0,
		"active": 1,
	};

	static local_date_time: t.local_date_timeT = {
		__name: "local_date_time",
		"min": 0,
	};

	static lunge_exercise_name: t.lunge_exercise_nameT = {
	...
	static manufacturer: t.manufacturerT = {
		__name: "manufacturer",
		"vdo": 287,
		"magneticdays": 288,
		"hammerhead": 289,
	...
	static mesg_count: t.mesg_countT = {
		__name: "mesg_count",
		"num_per_file": 0,
		"max_per_file": 1,
		"max_per_file_type": 2,
	...
	static message_index: t.message_indexT = {
	...
	static olympic_lift_exercise_name: t.olympic_lift_exercise_nameT = {
	...
	static plank_exercise_name: t.plank_exercise_nameT = {
	...
	static plyo_exercise_name: t.plyo_exercise_nameT = {
	...
	static power_phase_type: t.power_phase_typeT = {
	...
	static pull_up_exercise_name: t.pull_up_exercise_nameT = {
	...
	static push_up_exercise_name: t.push_up_exercise_nameT = {
	...
	static pwr_zone_calc: t.pwr_zone_calcT = {
		__name: "pwr_zone_calc",
		"custom": 0,
		"percent_ftp": 1,
	};

	static radar_threat_level_type: t.radar_threat_level_typeT = {
	...
	static rider_position_type: t.rider_position_typeT = {
	...
	static row_exercise_name: t.row_exercise_nameT = {
	...
	static run_exercise_name: t.run_exercise_nameT = {
	...
	static schedule: t.scheduleT = {
		__name: "schedule",
		"workout": 0,
		"course": 1,
	};

	static segment_delete_status: t.segment_delete_statusT = {
	...
	static segment_lap_status: t.segment_lap_statusT = {
		__name: "segment_lap_status",
		"end": 0,
		"fail": 1,
	};

	static segment_leaderboard_type: t.segment_leaderboard_typeT = {
	...
	static segment_selection_type: t.segment_selection_typeT = {
		__name: "segment_selection_type",
		"starred": 0,
		"suggested": 1,
	};

	static sensor_type: t.sensor_typeT = {
		__name: "sensor_type",
		"accelerometer": 0,
		"gyroscope": 1,
		"compass": 2,
	...
	static session_trigger: t.session_triggerT = {
	...
	static set_type: t.set_typeT = {
		__name: "set_type",
		"rest": 0,
		"active": 1,
	};

	static shoulder_press_exercise_name: t.shoulder_press_exercise_nameT = {
	...
	static shoulder_stability_exercise_name: t.shoulder_stability_exercise_nameT = {
	...
	static shrug_exercise_name: t.shrug_exercise_nameT = {
	...
	static sit_up_exercise_name: t.sit_up_exercise_nameT = {
	...
	static source_type: t.source_typeT = {
		__name: "source_type",
		"ant": 0,
		"antplus": 1,
		"bluetooth": 2,
	...
	static sport_bits_0: t.sport_bits_0T = {
		__name: "sport_bits_0",
		"generic": 0,
		"running": 0,
		"cycling": 0,
	...
	static sport_bits_1: t.sport_bits_1T = {
		__name: "sport_bits_1",
		"tennis": 0,
		"american_football": 0,
		"training": 0,
	...
	static sport_bits_2: t.sport_bits_2T = {
		__name: "sport_bits_2",
		"mountaineering": 0,
		"hiking": 0,
		"multisport": 0,
	...
	static sport_bits_3: t.sport_bits_3T = {
		__name: "sport_bits_3",
		"driving": 0,
		"golf": 0,
		"hang_gliding": 0,
	...
	static sport_bits_4: t.sport_bits_4T = {
		__name: "sport_bits_4",
		"sailing": 0,
		"ice_skating": 0,
		"sky_diving": 0,
	...
	static sport_bits_5: t.sport_bits_5T = {
		__name: "sport_bits_5",
		"water_skiing": 0,
		"kayaking": 0,
		"rafting": 0,
	...
	static sport_bits_6: t.sport_bits_6T = {
		__name: "sport_bits_6",
		"floor_climbing": 0,
	};

	static sport_event: t.sport_eventT = {
		__name: "sport_event",
		"uncategorized": 0,
		"geocaching": 1,
		"fitness": 2,
	...
	static squat_exercise_name: t.squat_exercise_nameT = {
	...
	static stroke_type: t.stroke_typeT = {
		__name: "stroke_type",
		"no_event": 0,
		"other": 1,
		"serve": 2,
	...
	static supported_exd_screen_layouts: t.supported_exd_screen_layoutsT = {
	...
	static swim_stroke: t.swim_strokeT = {
		__name: "swim_stroke",
		"freestyle": 0,
		"backstroke": 1,
		"breaststroke": 2,
	...
	static tap_sensitivity: t.tap_sensitivityT = {
	...
	static timer_trigger: t.timer_triggerT = {
	...
	static tissue_model_type: t.tissue_model_typeT = {
	...
	static total_body_exercise_name: t.total_body_exercise_nameT = {
	...
	static triceps_extension_exercise_name: t.triceps_extension_exercise_nameT = {
	...
	static user_local_id: t.user_local_idT = {
	...
	static warm_up_exercise_name: t.warm_up_exercise_nameT = {
	...
	static watchface_mode: t.watchface_modeT = {
	...
	static water_type: t.water_typeT = {
		__name: "water_type",
		"fresh": 0,
		"salt": 1,
		"en13319": 2,
	...
	static weather_report: t.weather_reportT = {
	...
	static weather_severe_type: t.weather_severe_typeT = {
	...
	static weather_severity: t.weather_severityT = {
	...
	static weather_status: t.weather_statusT = {
	...
	static weight: t.weightT = {
		__name: "weight",
		"calculating": 0,
	};

	static wkt_step_duration: t.wkt_step_durationT = {
	...
	static wkt_step_target: t.wkt_step_targetT = {
	...
	static workout_capabilities: t.workout_capabilitiesT = {
	...
	static workout_equipment: t.workout_equipmentT = {
	...
	static workout_hr: t.workout_hrT = {
		__name: "workout_hr",
		"bpm_offset": 100,
	};

	static workout_power: t.workout_powerT = {
	...
	static constant_types: t.constant_typesT = {
